...
type Config struct {
	DatabaseURL          string
	SourceURL            string
	InboundSyncEnabled   bool
	OutboundSyncEnabled  bool
...
func Load() *Config {
	return &Config{
		...
		InboundSyncEnabled:   getEnv("INBOUND_SYNC_ENABLED", "false") == "true",
		OutboundSyncEnabled:  getEnv("OUTBOUND_SYNC_ENABLED", "false") == "true",
